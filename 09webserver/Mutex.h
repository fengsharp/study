...
*/
class CAPABILITY("mutex") MutexLock : private NoneCopyable
{
private:
    friend class Condition;

    // for condition
    class UnassignGuard : private NoneCopyable
    {
    public:
...
/*
    SCOPED_CAPABILITY 实现了RAII风格的锁，构造时获取锁，析构时，释放锁
*/
class SCOPED_CAPABILITY MutexLockGuard : private NoneCopyable
{
public:
